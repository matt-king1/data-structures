...
int main() {
    ...
    // initialize class 
    HashTable setA(40009);
    string structName = "hashQuadratic";
    ...
    for(int i = 0; i < 400; ++i) {
        ...
        colInsert[i] = setA.getInsert();
        colSearch[i] = setA.getSearch();
    ...
    string colFinal = "setA_collisions.csv";
